...
const TeacherList = [
  {
    name: "Batman",
    bio: "Batman is a JavaScript developer working on large-scale applications. He's also a teacher who strives to support students in removing all barriers to learning code.",
    img_src: "images/batman.png",
    id: "teach-3"
  },
  {
    name: "Flash",
    bio: "'Flash is a software engineer and philosopher trying to leave the world better than he found it. He codes for non-profits, eCommerce, and large-scale web apps.",
    img_src: "images/flash.png",
    id: "teach-2"
  },

  {
    name: "Catwoman",
    bio: "Catwoman found her passion for computers and programming over 15 years ago. She is excited to introduce people to the wonderful world of JavaScript.",
    img_src: "images/gatubela.png",
    id: "teach-4"
  },
  {
    name: "Hulk",
    bio: "Jay is a developer, author of CSS: The Missing Manual, JavaScript & jQuery: The Missing Manual, and web development teacher.",
    img_src: "images/hulk.png",
    id: "teach-5"
  },
  {
    name: "Superman",
    bio: "All of his professional life, Superman has worked with computers online; he is a polyglot programmer and likes using the right tools for the job.",
    img_src: "images/superman.png",
    id: "teach-6"
  },
  {
    name: "Wonder woman",
    bio: "Wonder woman is a web developer and teacher who is passionate about building scalable, data driven web apps, especially ones that address old problems with new tech!",
    img_src: "images/wonderWoman.png",
    id: "teach-1"
  }
];
const CSSCourses = [
